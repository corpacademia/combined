...
, {
        ...
        // Delete standard lab
        const instanceDetails = await axios.post(`${process.env.url}:3000/api/v1/lab_ms/awsInstanceOfUsers`
, {
          lab_id: lab.lab_id,
          user_id: userId,
        });
...
, {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const response = await axios.post(`${process.env.url}:3000/api/v1/cloud_slice_ms/updateUserCloudSliceTimes`
, {
        userId: userId,
