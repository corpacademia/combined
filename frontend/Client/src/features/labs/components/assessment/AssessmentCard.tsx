...
,
  ...
  const pdfGenerate = (users) => {
   ...
   const mail = async (formData)=>{
    const emailResponse = await axios.post(`${process.env.url}:3000/api/v1/sendmail`
, formData, {
      headers: {
 ...
 */
        ...
        const handleCreateUser = async () => {
          ...
          try {
            ...
            const insertUsersResponse = await axios.post(`${process.env.url}:3000/api/v1/user_ms/insertUsers`
, {
              users: users,
            ...
            const assignLabResponse = await axios.post(`${process.env.url}:3000/api/v1/lab_ms/assignlab`
, {
