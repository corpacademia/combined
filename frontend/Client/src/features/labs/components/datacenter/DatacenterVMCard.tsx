...
if (userGuideFile) {
  formData.append('userGuide', userGuideFile); // actual file
      ...
      // Update lab details
      const labResponse = await axios.post(`${process.env.url}:3000/api/v1/lab_ms/updateSingleVmDatacenterLab`
, formData, {
        headers: {
      ...
      //     await axios.post(`${process.env.url}:3000/api/v1/lab_ms/editSingleVmDatacenterCreds`
, {
      //       labId: vm.lab_id,
      //       id: cred.id,
      //       username: cred.username,
      ...
      //     await axios.post(`${process.env.url}:3000/api/v1/lab_ms/addSingleVmDatacenterCreds`
, {
      //       labId: vm.lab_id,
      //       username: cred.username,
      //       password: cred.password,
